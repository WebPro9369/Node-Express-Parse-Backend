define([
	...
	var view = Parse.View.extend({
		...
		initialize : function(options) {
			...
			_.bindAll(this, 'assign', 'sync', 'render', 'fetch', 'total', 'addSizeModel', 'removeSizeModel', 'updateSizeModel', 'resetSizeCollection', 'updateSizeCollection', 'apply', 'doSizeCreate', 'makeSizeCreate');
