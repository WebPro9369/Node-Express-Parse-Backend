define([
	...
	var view = Parse.View.extend({
		...
		events : {
			...
			'change [name="product-size-title-us"]'				: 'doChangeTitleUS',
		...
		initialize : function(options) {
			...
			_.bindAll(this, 'render', 'doChangeTitle', 'doChangeTitleUS', 'doChangeQuantity', 'doRemove');
		...
		doChangeTitleUS : function (ev) {
			
			if (app.DEBUG_LEVEL == DEBUG_LEVEL.TRACE) console.log('ProductSizeItem.doChangeTitleUS');
			
			var
				$target = $(ev.currentTarget),
				value = $target.val()
			
			this.model.set('nameUS', value);
