define([
	...
	var view = Parse.View.extend({
		...
		initialize : function(options) {
			...
			if (app.DEBUG_LEVEL == DEBUG_LEVEL.TRACE) console.log('CollectionView.initialize');
		...
		render : function() {
			...
			if (app.DEBUG_LEVEL == DEBUG_LEVEL.TRACE) console.log('CollectionView.render');
		...
		fetch : function () {
			...
			if (app.DEBUG_LEVEL == DEBUG_LEVEL.TRACE) console.log('CollectionView.fetch');
		...
		build : function (model) {
			...
			if (app.DEBUG_LEVEL == DEBUG_LEVEL.TRACE) console.log('CollectionView.build');
			
			this.model = model;
			
			this.$('.modal-title').html('<strong>Collection</strong> view <span class="pull-right">' + this.model.id + '</span>');
