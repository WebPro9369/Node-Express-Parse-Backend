...
lodash.extend(AbsoluteAnchor.prototype, {
    /**
...
lodash.extend(OneCellAnchor.prototype, {
...
var Picture = function () {
    this.media = null;
    this.id = lodash.uniqueId('Picture');
...
lodash.extend(Picture.prototype, {
    ...
    setFillConfig: function (config) {
        lodash.extend(this.fill, config);
    },
...
lodash.extend(TwoCellAnchor.prototype, {
...
var Drawing = function () {
    this.id = lodash.uniqueId('Drawing');
};

lodash.extend(Drawing.prototype, {
    /**
     *
...
var Drawings = function () {
    ...
    this.id = lodash.uniqueId('Drawings');
};

lodash.extend(Drawings.prototype, {
    /**
...
lodash.uniqueId('rId'); //priming

lodash.extend(RelationshipManager.prototype, {
    ...
    toXML: function () {
        ...
        lodash.each(this.relations, function (data, id) {
...
var sharedStrings = function () {
    this.strings = {};
    this.stringArray = [];
    this.id = lodash.uniqueId('SharedStrings');
};
lodash.extend(sharedStrings.prototype, {
    /**
...
lodash.extend(SheetProtection.prototype, {
...
lodash.extend(SheetView.prototype, {
...
var StyleSheet = function () {
    this.id = lodash.uniqueId('StyleSheet');
    this.cellStyles = [{
        name:"Normal",
        xfId:"0",
        builtinId:"0"
...
lodash.extend(StyleSheet.prototype, {
    ...
    */
    ...
    createDifferentialStyle: function (styleInstructions) {
        ...
        if (styleInstructions.border && lodash.isObject(styleInstructions.border)) {
            style.border = lodash.defaults(styleInstructions.border, {
                top: {},
                left: {},
                right: {},
                bottom: {},
    ...
    */
    ...
    exportColor: function (doc, color) {
        ...
        if (!lodash.isUndefined(color.tint)) {
            colorEl.setAttribute('tint', color.tint);
        }
        if (!lodash.isUndefined(color.auto)) {
            colorEl.setAttribute('auto', !!color.auto);
        }
        if (!lodash.isUndefined(color.theme)) {
    ...
    exportCellFormatElement: function (doc, styleInstructions) {
        ...
        var attributes = lodash.filter(lodash.keys(styleInstructions), function (key) {
            if(lodash.indexOf(allowed, key) !== -1) {
                return true;
            }
        });
    ...
    exportAlignment: function (doc, alignmentData) {
        ...
        var keys = lodash.keys(alignmentData);
    ...
    */
    exportPatternFill: function (doc, data) {
        ...
        if(lodash.isString(data.bgColor)) {
        ...
        if(lodash.isString(data.fgColor)) {
    ...
    exportCellStyles: function (doc) {
        ...
        for(var i = 0, l = this.cellStyles.length; i < l; i++) {
            ...
            var attributes = lodash.keys(style);
            var a = attributes.length;
            while(a--) {
    ...
    exportTableStyle: function (doc, style) {
        ...
        lodash.each(style, function (value, key) {
            if(key === 'name') {return;}
            i++;
...
lodash.extend(Table.prototype, {

    initialize: function (config) {
        this.displayName = lodash.uniqueId("Table");
    ...
    setTableColumns: function (columns) {
        lodash.each(columns, function (column) {
...
lodash.extend(Workbook.prototype, {

    initialize: function () {
        this.id = lodash.uniqueId('Workbook');
    ...
    _prepareFilesForPackaging: function (files) {
        ...
        lodash.each(files, function (value, key) {
 ...
 */
    ...
    lodash.extend(Worksheet.prototype, {
        
        initialize: function (config) {
            config = config || {};
            this.name = config.name;
            this.id = lodash.uniqueId('Worksheet');
        ...
        */
        ...
        compilePageDetailPiece: function (data) {
            ...
            if(lodash.isObject(data) && !lodash.isArray(data)) { 
                var string = "";
            ...
            if(lodash.isArray(data)) {
                var self = this;
                return lodash.reduce(data, function (m, v) {
...
lodash.extend(XMLDOM.prototype, {
...
XMLDOM.TextNode = function (text) {
 ...
 lodash.extend(XMLDOM.TextNode.prototype, {
     toJSON: function () {
         return {
    ...
    toString: function () {
        return lodash.escape(this.nodeValue);
    }
 });
...
lodash.extend(XMLDOM.XMLNode.prototype, {

    toString: function () {
        var string = "<" + this.nodeName;
        for(var attr in this.attributes) {
            if(this.attributes.hasOwnProperty(attr)) {
                string = string + " " + attr + "=\""+lodash.escape(this.attributes[attr])+"\"";
            }
        }
...
var util = {
    ...
    setAttributesOnDoc: function (doc, attrs) {
        lodash.forEach(attrs, function (v, k) {
...
lodash.extend(Template.prototype, {
    setHeader: function () {
...
var Factory = {
    ...
    createFile: function (workbook, options) {
        ...
        return workbook.generateFiles().then(function (files) {
            lodash.each(files, function (content, path) {
                path = path.substr(1);
            ...
            return zip.generate(lodash.defaults(options || {}, {
                type: "base64"
            }));
        });
    }
